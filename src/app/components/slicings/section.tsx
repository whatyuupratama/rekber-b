...
import { Shield, Zap, Users, CheckCircle, Clock, HeadphonesIcon, UserPlus, CreditCard, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl p-8">
                <div className="mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 text-center mb-2">Buat Rekening Bersama</h3>
                  <p className="text-gray-600 text-center text-sm">Mulai transaksi aman Anda sekarang</p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-700 block">Nominal</label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-700 block">Jenis Transaksi</label>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Mengapa Pilih Rekber?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-white border border-gray-100 shadow-lg rounded-2xl p-8 text-center hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600">Dana Anda dijamin aman dengan sistem escrow terpercaya dan terenkripsi</p>
            </Card>
            ...
            <Card className="bg-white border border-gray-100 shadow-lg rounded-2xl p-8 text-center hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Proses Cepat</h3>
              <p className="text-gray-600">Transaksi diproses dengan cepat dan efisien dalam hitungan menit</p>
            </Card>
            ...
            <Card className="bg-white border border-gray-100 shadow-lg rounded-2xl p-8 text-center hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Support 24/7</h3>
              <p className="text-gray-600">Tim support profesional siap membantu Anda kapan saja dibutuhkan</p>
            </Card>
            ...
            <Card className="bg-white border border-gray-100 shadow-lg rounded-2xl p-8 text-center hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600">Dipercaya oleh ribuan pengguna dengan rating kepuasan tinggi</p>
            </Card>
            ...
            <Card className="bg-white border border-gray-100 shadow-lg rounded-2xl p-8 text-center hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600">Pantau status transaksi Anda secara real-time dengan notifikasi instant</p>
            </Card>
            ...
            <Card className="bg-white border border-gray-100 shadow-lg rounded-2xl p-8 text-center hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600">Bergabung dengan komunitas trader dan seller terpercaya di Indonesia</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Cara Kerja Rekber</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <Card className="bg-white border-0 shadow-lg rounded-2xl p-8 mb-4 hover:shadow-xl transition-shadow">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-3">1. Daftar</h3>
                  <p className="text-gray-600 text-sm">Buat akun dan verifikasi identitas Anda dengan mudah</p>
                </CardContent>
              </Card>
            ...
            <div className="text-center">
              <Card className="bg-white border-0 shadow-lg rounded-2xl p-8 mb-4 hover:shadow-xl transition-shadow">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-3">2. Deposit</h3>
                  <p className="text-gray-600 text-sm">Pembeli melakukan deposit dana ke rekening bersama</p>
                </CardContent>
              </Card>
              <div className="hidden lg:block">
                <ArrowRight className="w-6 h-6 text-gray-400 mx-auto" />
            ...
            <div className="text-center">
              <Card className="bg-white border-0 shadow-lg rounded-2xl p-8 mb-4 hover:shadow-xl transition-shadow">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-3">3. Transaksi</h3>
                  <p className="text-gray-600 text-sm">Penjual mengirim barang, pembeli konfirmasi penerimaan</p>
                </CardContent>
              </Card>
              <div className="hidden lg:block">
                <ArrowRight className="w-6 h-6 text-gray-400 mx-auto" />
            ...
            <div className="text-center">
              <Card className="bg-white border-0 shadow-lg rounded-2xl p-8 mb-4 hover:shadow-xl transition-shadow">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-3">4. Selesai</h3>
                  <p className="text-gray-600 text-sm">Dana otomatis diteruskan ke penjual setelah konfirmasi</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed">
                Platform rekening bersama terpercaya untuk transaksi online yang aman dan terjamin.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Rekber.com. All rights reserved. Made with ❤️ in Indonesia</p>
          </div>
        </div>
      </footer>
    </div>
