...
export default function VerificationForm() {
  ...
  const handleFileChange = (field: "selfieFile" | "photoFile") => (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          <p className="text-xs text-green-600 mt-2 font-medium">Supported mimes: jpg, jpeg, png</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> 
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-3">Verifikasi Identitas</h1>
          <p className="text-slate-600 text-lg leading-relaxed">
            Lengkapi formulir di bawah ini untuk memverifikasi identitas Anda dan mengaktifkan semua fitur platform.
          </p>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-white/70 backdrop-blur-sm">
          <CardHeader className="pb-8">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <CardTitle className="text-2xl font-bold text-slate-800">Formulir Verifikasi</CardTitle>
            </div>
            <CardDescription className="text-slate-600 text-base leading-relaxed">
              Pastikan semua informasi yang Anda masukkan akurat dan sesuai dengan dokumen resmi Anda.
            </CardDescription>
          </CardHeader>

          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              {/* Row 1: Full Name and NIK */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <Label htmlFor="nikKtp" className="text-sm font-semibold text-slate-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <FileUploadArea field="selfieFile" label="Foto Selfie Memegang KTP" icon={Camera} />
                <FileUploadArea field="photoFile" label="Foto Diri Kamu" icon={User} hasInfo={true} />
              </div>
